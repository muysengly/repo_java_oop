...
- The relationship between a superclass and subclass is often described as an "is-a" relationship.
...
- **Type**: The declared type of a variable (e.g., `GeometricObject`).
- **Subtype**: The actual type of the object assigned to the variable (e.g., `Circle`, `Rectangle`).
