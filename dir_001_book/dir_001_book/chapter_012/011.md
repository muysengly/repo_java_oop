...
# Chapter 11: <br> Inheritance and Polymorphism

---

## 11.1. Introduction to <br> Inheritance and Polymorphism
...
- It allows a new class (subclass) to inherit properties and behaviors from an existing class (superclass).
...
- Types of polymorphism in Java:
  ...
  - **Runtime Polymorphism**: Achieved through method overriding and dynamic binding.

---

### Why Use Polymorphism?

- **Flexibility**: Allows methods to operate on objects of different classes.
- **Extensibility**: New classes can be added without modifying existing code.
- **Code Clarity**: Simplifies code by allowing a single method to handle multiple types.
- **Dynamic Behavior**: The actual method invoked is determined at runtime based on the object's type.

**Example**: Geometric Object

- A method that calculates the area of any geometric object.
- Can accept Circle, Rectangle, or Triangle objects.
- The specific area calculation is determined at runtime based on the actual object type.
...
- **Superclass** or **Parent Class** is the general class from which other classes inherit.
- Contains common properties and methods that can be shared with subclasses.

<br>

- **Subclass** or **Child Class** is a specialized version of the superclass.
- Inherits properties and methods from the superclass.
- Can add new properties and methods or override existing ones.

<br>

**Note**: The relationship between a superclass and subclass is often described as an **"is-a"** relationship.

---

### The `extends` Keyword

- The `extends` keyword is used to create a subclass from a superclass in Java.
...
- This establishes an inheritance relationship where `SubclassName` inherits from `SuperclassName`.

---

### Example of GeometricObject Class
...
- **Properties**
  ...
  - `color`: The color of the geometric object.
  - `filled`: Indicates whether the object is filled with color.
  - `dateCreated`: The date the object was created.

- **Methods**
  - `getColor()`: Returns the color of the object.
  - `setColor(String color)`: Sets the color of the object.
  - `isFilled()`: Returns whether the object is filled.
  - `setFilled(boolean filled)`: Sets the filled status.
  - `getDateCreated()`: Returns the creation date.
...
- It allows access to superclass constructors, methods, and properties.
- Essential for constructor chaining and method overriding.
- Helps avoid naming conflicts between superclass and subclass members.
- Ensures proper initialization of superclass members in subclass constructors.
- Enables access to overridden methods in the superclass.
- Facilitates code reuse by allowing subclasses to leverage superclass functionality.
- Supports polymorphism by enabling method calls on superclass references.
- Provides a way to call superclass methods that have been overridden in the subclass.
...
- The `super` keyword is used to call a constructor of the superclass.
- This is typically done in the first line of a subclass constructor
...
- It helps catch errors at compile time if the method does not actually override anything.
- If the method signature does not match any method in the superclass, the compiler will generate an error.
- It improves code readability and maintainability by clearly indicating overridden methods.
...
### Common Mistake: Incorrect Method Signature
...
### Differences Between `Arrays` & `ArrayList`
...
## 11.13. Case Study: <br> A Custom Stack Class
...
<!-- <img src="image-18.png" alt="alt text" height=90% /> -->

---

<!-- <img src="image-19.png" alt="alt text" width=90% /> -->

![bg auto 70%](image-19.png)

---

<!-- <img src="image-20.png" alt="alt text" width=90% /> -->

![bg auto 70%](image-20.png)

---

<!-- <img src="image-56.png" alt="alt text" width=90% /> -->

![bg auto 70%](image-56.png)

---

<!-- <img src="image-57.png" alt="alt text" height=90% /> -->

![bg auto 70%](image-57.png)

---

<!-- <img src="image-58.png" alt="alt text" width=90% /> -->

![bg auto 80%](image-58.png)

---

<!-- <img src="image-59.png" alt="alt text" width=90% /> -->

![bg auto 90%](image-59.png)

<!-- <img src="image-62.png" alt="alt text" height=90% /> -->

![bg auto 90%](image-62.png)
