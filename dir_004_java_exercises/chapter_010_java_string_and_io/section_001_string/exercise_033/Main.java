...
public class Main {
    ...
    public static void allInterleavings(String res, String P, String Q, Set<String> out) {
        ...
        // If string P is not empty, recursively call allInterleavings with the first
        // character of P removed.
        if (P.length() > 0) {
            allInterleavings(res + P.charAt(0), P.substring(1), Q, out);
        }

        // If string Q is not empty, recursively call allInterleavings with the first
        // character of Q removed.
        if (Q.length() > 0) {
    ...
    public static void main(String[] args) {
        ...
        // Call the allInterleavings method to generate interleavings of the input
        // strings.
