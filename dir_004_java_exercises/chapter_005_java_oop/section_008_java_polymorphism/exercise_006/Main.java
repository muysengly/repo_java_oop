...
public class Main { // Declare the Main class
  public static void main(String[] args) { // Define the main method
    ...
    double rs1 = 4.0, rs2 = 6.0; // Initialize double variables rs1 and rs2 with the values 4.0 and 6.0
                                 // respectively
    double ts1 = 3.0, ts2 = 4.0, ts3 = 5.0; // Initialize double variables ts1, ts2, and ts3 with the values 3.0, 4.0,
                                            // and 5.0 respectively

    Rectangle rectangle = new Rectangle(rs1, rs2); // Create an instance of the Rectangle class with sides rs1 and rs2
    Triangle triangle = new Triangle(ts1, ts2, ts3); // Create an instance of the Triangle class with sides ts1, ts2,
                                                     // and ts3
...
class Triangle extends Shape { // Declare a subclass Triangle that extends the Shape class
  ...
  public Triangle(double side1, double side2, double side3) { // Define a constructor that takes three double parameters
